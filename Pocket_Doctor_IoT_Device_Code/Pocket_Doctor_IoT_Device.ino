/*Pocket Doctor IoT Device
 * -----------------------
 * Team Sushruta
 * -----------------------
 * 1. Subha Sundar Chakraborty
 * 2. Sreeparna Ray
 * 3. Anik Chatterjee
*/
...
#define DS18B20 D6 //D4 pin= GPIO pin 2
#define REPORTING_PERIOD_MS     1000

float temperature, humidity, BPM, SpO2, bodytemperature;

/*Put your SSID & Password*/
const char* ssid = "on7pro";  // Enter SSID here
const char* password = "7003522824";  //Enter Password here
...
html += "<h1>Pocket Doctor IoT Device</h1>";
html += "<h3><a href='https://sushruta.com'>Team Sushruta</a></h3>";
html += "</div>";
